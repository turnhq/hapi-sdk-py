...
class MultipleContractsResponseModel(object):

    """Implementation of the 'MultipleContractsResponse' model.
    ...
    def __init__(self,
        ...
        """Constructor for the MultipleContractsResponseModel class"""
