...
from hapi.http.requests_client import RequestsClient
...
class Configuration(object):
    ...
    def clone_with(self, http_client_instance=None,
                   ...
                   x_auth_token=None, x_customer_id=None,
        ...
        x_auth_token = x_auth_token or self.x_auth_token
        x_customer_id = x_customer_id or self.x_customer_id
        ...
        return Configuration(
            ...
            environment=environment, x_auth_token=x_auth_token,
