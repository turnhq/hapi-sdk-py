...
| `ordered_products_specs` | [`List of OrderedProductsGetElementModel`](../../doc/models/ordered-products-get-element-model.md) | Optional | This part contains information of the ordered products. |
| `postings` | [`List of CampaignPostingModel`](../../doc/models/campaign-posting-model.md) | Optional | - |
