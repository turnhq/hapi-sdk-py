...
|  --- | --- | --- | --- |
| `company_id` | `List of string` | Required | - |
| `posting_details` | [`PostingDetailsErrorsModel`](../../doc/models/posting-details-errors-model.md) | Required | - |
| `target_group` | `List of string` | Required | - |
| `recruiter_info` | [`RecruiterInfoErrorsModel`](../../doc/models/recruiter-info-errors-model.md) | Required | - |
| `ordered_products` | `List of string` | Required | - |
| `ordered_products_specs` | [`List of OrderedProductsSpecModel`](../../doc/models/ordered-products-spec-model.md) | Required | - |
