...
body.credentials = jsonpickle.decode('{"key1":"val1","key2":"val2"}')
...
[`List of AutocompleteValuesResponseModel`](../../doc/models/autocomplete-values-response-model.md)
...
result = contracts_controller.list_channels(None, None, None, accept_language)
```
...
result = contracts_controller.retrieve_channel(channel_id, accept_language)
```
...
| Parameter | Type | Tags | Description |
|  --- | --- | --- | --- |
| `contracts_ids` | `List of string` | Template, Required | - |
| `limit` | `float` | Query, Optional | Amount of contracts returned |
| `offset` | `float` | Query, Optional | Starting point |
